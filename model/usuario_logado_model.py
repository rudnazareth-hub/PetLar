...
class UsuarioLogado:
    ...
    def is_adotante(self) -> bool:
        """Verifica se o usuário é adotante."""
        return self.perfil == Perfil.ADOTANTE.value

    def is_abrigo(self) -> bool:
        """Verifica se o usuário é abrigo."""
        return self.perfil == Perfil.ABRIGO.value
    ...
    def tem_perfil(self, *perfis: str) -> bool:
        ...
        Exemplo:
            if usuario.tem_perfil(Perfil.ADMIN.value, Perfil.ABRIGO.value):
                # lógica para admin ou abrigo
        """
