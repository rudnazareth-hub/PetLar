...
class TestListarBackups:
    ...
    def test_listar_backups_requer_admin(self, adotante_autenticado):
        """Adotante não deve acessar listagem de backups"""
    ...
    def test_abrigo_nao_acessa_listagem(self, abrigo_autenticado):
        """Abrigo não deve acessar listagem de backups"""
        response = abrigo_autenticado.get(
            "/admin/backups/listar", follow_redirects=False
        )
        assert response.status_code in [
            status.HTTP_303_SEE_OTHER,
...
class TestCriarBackup:
    ...
    def test_adotante_nao_pode_criar_backup(self, adotante_autenticado):
        """Adotante não deve poder criar backup"""
    ...
    def test_abrigo_nao_pode_criar_backup(self, abrigo_autenticado):
        """Abrigo não deve poder criar backup"""
        response = abrigo_autenticado.post(
            "/admin/backups/criar", follow_redirects=False
        )
        assert response.status_code in [
            status.HTTP_303_SEE_OTHER,
...
class TestRestaurarBackup:
    ...
    def test_adotante_nao_pode_restaurar_backup(
        self, adotante_autenticado, criar_backup
    ):
        """Adotante não deve poder restaurar backup"""
        criar_backup()
        from util import backup_util
...
class TestExcluirBackup:
    ...
    def test_adotante_nao_pode_excluir_backup(self, adotante_autenticado, criar_backup):
        """Adotante não deve poder excluir backup"""
        criar_backup()
        from util import backup_util
...
class TestDownloadBackup:
    ...
    def test_adotante_nao_pode_baixar_backup(self, adotante_autenticado, criar_backup):
        """Adotante não deve poder baixar backup"""
        criar_backup()
        from util import backup_util
    ...
    def test_abrigo_nao_pode_baixar_backup(self, abrigo_autenticado, criar_backup):
        """Abrigo não deve poder baixar backup"""
        criar_backup()
        from util import backup_util
