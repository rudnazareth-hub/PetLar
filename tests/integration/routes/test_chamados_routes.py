...
class TestCriarChamado:
    ...
    def test_get_formulario_cadastro(self, adotante_autenticado):
        """Usuário autenticado deve acessar formulário de cadastro"""
        response = adotante_autenticado.get("/chamados/cadastrar")
        assert response.status_code == status.HTTP_200_OK
        assert "chamado" in response.text.lower()

    def test_criar_chamado_com_dados_validos(self, adotante_autenticado):
    ...
    def test_criar_chamado_titulo_curto(self, adotante_autenticado):
    ...
    def test_criar_chamado_titulo_longo(self, adotante_autenticado):
    ...
    def test_criar_chamado_descricao_curta(self, adotante_autenticado):
    ...
    def test_criar_chamado_sem_prioridade(self, adotante_autenticado):
    ...
    def test_criar_chamado_prioridade_invalida(self, adotante_autenticado):
    ...
    def test_chamado_criado_com_status_aberto(self, adotante_autenticado):
        """Chamado criado deve ter status 'Aberto'"""
        # Criar chamado
        adotante_autenticado.post(
            "/chamados/cadastrar",
            data={
        ...
        response = adotante_autenticado.get("/chamados/listar")
        assert response.status_code == status.HTTP_200_OK
...
class TestListarChamados:
    ...
    def test_listar_chamados_usuario(self, adotante_autenticado):
        """Usuário deve conseguir listar seus chamados"""
        response = adotante_autenticado.get("/chamados/listar")
        assert response.status_code == status.HTTP_200_OK
        assert "chamado" in response.text.lower()

    def test_usuario_ve_apenas_proprios_chamados(self, client, adotante_autenticado):
        """Usuário deve ver apenas seus próprios chamados"""
        # Este adotante já está autenticado como um usuário comum
...
class TestVisualizarChamado:
    ...
    def test_visualizar_proprio_chamado(self, adotante_autenticado):
        ...
        response = adotante_autenticado.get("/chamados/1/visualizar")
        assert response.status_code == status.HTTP_200_OK
        assert "Problema urgente" in response.text

    def test_visualizar_chamado_inexistente(self, adotante_autenticado):
...
class TestExcluirChamado:
    ...
    def test_excluir_proprio_chamado(self, adotante_autenticado):
        ...
        # Excluir
        response = adotante_autenticado.post(
            "/chamados/1/excluir", follow_redirects=False
        )
        assert response.status_code == status.HTTP_303_SEE_OTHER

    def test_excluir_chamado_inexistente(self, adotante_autenticado):
...
class TestAdminListarChamados:
    ...
    def test_usuario_comum_nao_acessa_admin_listagem(self, adotante_autenticado):
...
class TestAdminResponderChamado:
    ...
    def test_admin_acessa_formulario_responder(
        self, adotante_autenticado, admin_autenticado
    ):
    ...
    def test_usuario_comum_nao_pode_responder(self, adotante_autenticado):
...
class TestHistoricoInteracoes:
    ...
    def test_usuario_pode_responder_proprio_chamado(self, adotante_autenticado):
        ...
        response = adotante_autenticado.post(
            f"/chamados/{chamado_id}/responder",
    ...
    def test_historico_mostra_todas_interacoes(
        ...
        # Verificar histórico
        response = adotante_autenticado.get(f"/chamados/{chamado_id}/visualizar")
        assert response.status_code == status.HTTP_200_OK
...
class TestFluxoCompleto:
    ...
    def test_fluxo_completo_usuario_e_admin(
        self, adotante_autenticado, admin_autenticado
    ):
...
class TestReabrirChamado:
    ...
    def test_admin_reabre_chamado_fechado(
        self, adotante_autenticado, admin_autenticado
    ):
    ...
    def test_reabrir_chamado_nao_fechado(self, adotante_autenticado, admin_autenticado):
...
class TestErrosAdminChamados:
    ...
    def test_erro_ao_salvar_resposta(self, adotante_autenticado, admin_autenticado):
    ...
    def test_erro_ao_fechar_chamado(self, adotante_autenticado, admin_autenticado):
    ...
    def test_erro_ao_reabrir_chamado(self, adotante_autenticado, admin_autenticado):
...
class TestRateLimitChamados:
    ...
    def test_rate_limit_criar_chamado(self, adotante_autenticado):
    ...
    def test_rate_limit_responder_chamado(self, adotante_autenticado):
...
class TestExclusaoChamado:
    ...
    def test_excluir_chamado_nao_aberto(self, adotante_autenticado, admin_autenticado):
...
class TestValidacaoResposta:
    ...
    def test_resposta_invalida_validation_error(self, adotante_autenticado):
    ...
    def test_responder_chamado_inexistente(self, adotante_autenticado):
