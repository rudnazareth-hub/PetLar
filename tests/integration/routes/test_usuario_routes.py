...
class TestDashboard:
    ...
    def test_dashboard_usuario_adotante(self, adotante_autenticado):
        """Adotante autenticado pode acessar dashboard"""
        response = adotante_autenticado.get("/usuario")
        assert response.status_code == status.HTTP_200_OK

    def test_dashboard_exibe_dados_usuario(self, adotante_autenticado, usuario_teste):
    ...
    def test_dashboard_abrigo(self, abrigo_autenticado, abrigo_teste):
        """Abrigo autenticado pode acessar dashboard"""
        response = abrigo_autenticado.get("/usuario")
        assert response.status_code == status.HTTP_200_OK
        assert abrigo_teste["nome"] in response.text
...
class TestVisualizarPerfil:
    ...
    def test_visualizar_perfil_usuario_autenticado(
        self, adotante_autenticado, usuario_teste
    ):
        """Usuário autenticado deve ver seu perfil"""
        response = adotante_autenticado.get("/usuario/perfil/visualizar")
        assert response.status_code == status.HTTP_200_OK
        assert usuario_teste["nome"] in response.text
        assert usuario_teste["email"] in response.text

    def test_visualizar_perfil_usuario_nao_encontrado(self, adotante_autenticado):
...
class TestEditarPerfil:
    ...
    def test_get_formulario_edicao_usuario_autenticado(self, adotante_autenticado):
        """Usuário autenticado deve acessar formulário de edição"""
        response = adotante_autenticado.get("/usuario/perfil/editar")
        assert response.status_code == status.HTTP_200_OK
        assert "editar" in response.text.lower() or "perfil" in response.text.lower()

    def test_editar_perfil_com_dados_validos(self, adotante_autenticado, usuario_teste):
        ...
        response_visualizar = adotante_autenticado.get("/usuario/perfil/visualizar")
    ...
    def test_editar_perfil_com_nome_vazio(self, adotante_autenticado, usuario_teste):
    ...
    def test_editar_perfil_com_email_invalido(self, adotante_autenticado):
    ...
    def test_editar_perfil_atualiza_sessao(self, adotante_autenticado, usuario_teste):
    ...
    def test_get_editar_perfil_rate_limit(self, adotante_autenticado):
...
class TestAlterarSenha:
    ...
    def test_get_formulario_alterar_senha_usuario_autenticado(
        self, adotante_autenticado
    ):
        """Usuário autenticado deve acessar formulário de alteração de senha"""
        response = adotante_autenticado.get("/usuario/perfil/alterar-senha")
        assert response.status_code == status.HTTP_200_OK
        assert_contains_text(response, "senha")

    def test_alterar_senha_com_dados_validos(self, adotante_autenticado, usuario_teste):
        ...
        adotante_autenticado.get("/logout")
        response_login = adotante_autenticado.post(
            "/login",
    ...
    def test_alterar_senha_com_senha_atual_incorreta(self, adotante_autenticado):
    ...
    def test_alterar_senha_nova_igual_atual(self, adotante_autenticado, usuario_teste):
    ...
    def test_alterar_senha_senhas_nao_coincidem(
        self, adotante_autenticado, usuario_teste
    ):
    ...
    def test_alterar_senha_nova_fraca(self, adotante_autenticado, usuario_teste):
    ...
    def test_get_alterar_senha_rate_limit(self, adotante_autenticado):
        """Rate limit deve bloquear acesso ao formulário"""
        with patch(
            "routes.usuario_routes.form_get_limiter.verificar", return_value=False
        ):
    ...
    def test_post_alterar_senha_rate_limit(self, adotante_autenticado):
...
class TestAtualizarFoto:
    ...
    def test_atualizar_foto_com_dados_validos(
        self, adotante_autenticado, foto_teste_base64
    ):
    ...
    def test_atualizar_foto_com_dados_invalidos(self, adotante_autenticado):
    ...
    def test_atualizar_foto_muito_grande(self, adotante_autenticado):
    ...
    def test_atualizar_foto_vazia(self, adotante_autenticado):
    ...
    def test_post_atualizar_foto_rate_limit(self, adotante_autenticado):
    ...
    def test_atualizar_foto_erro_io(self, adotante_autenticado):
    ...
    def test_atualizar_foto_erro_os(self, adotante_autenticado):
